...
$count_stmt = $conn->prepare("SELECT COUNT(*) as count FROM customers $where");
if ($search) $count_stmt->bind_param("ss", $searchTerm, $searchTerm);
$count_stmt->execute();
$total_records = $count_stmt->get_result()->fetch_assoc()['count'];

$stmt = $conn->prepare("SELECT * FROM customers $where LIMIT ?, ?");
if ($search) {
...
<div class="row">
    <div class="col-md-12 d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <button class="btn btn-primary no-print" data-bs-toggle="modal" data-bs-target="#addCustomerModal">
